// Generated at 2020-07-27 12:37:14 (325ms) for vnull+
...
function room_pack_load_map(l_map, l_x, l_y, l_flags) {
	/// room_pack_load_map(map:dynamic, x:real = 0, y:real = 0, flags:RoomPackBitFlags = 46)
	/// @param {dynamic} map
	/// @param {real} x=0
	/// @param {real} y=0
...
function room_pack_load_string(l_str, l_x, l_y, l_flags) {
	/// room_pack_load_string(str:string, x:real = 0, y:real = 0, flags:RoomPackBitFlags = 46)->bool
	/// @param {string} str
	/// @param {real} x=0
	/// @param {real} y=0
	/// @param {RoomPackBitFlags} flags=46
...
function room_pack_load_file(l_path1, l_x, l_y, l_flags) {
	/// room_pack_load_file(path:string, x:real = 0, y:real = 0, flags:RoomPackBitFlags = 46)->bool
	/// @param {string} path
	/// @param {real} x=0
	/// @param {real} y=0
	/// @param {RoomPackBitFlags} flags=46
...
function room_pack_raw_anim_speed(l_val, l_type) {
	// room_pack_raw_anim_speed(val:real, type:string)->real
	...
	switch (l_ql[?"modelName"]) {
		...
		case "GMRTileLayer":
			if (room_pack_raw_apply_tiles) {
				...
				var l_rt = layer_tilemap_create(l_rl, room_pack_raw_room_x + l_qt[?"x"], room_pack_raw_room_y + l_qt[?"y"], asset_get_index(l_qt[?"tileset"]), l_qtw, l_qth);
...
// room.pack:
globalvar room_pack_flag_settings; room_pack_flag_settings = 1;
globalvar room_pack_flag_instances; room_pack_flag_instances = 2;
globalvar room_pack_flag_backgrounds; room_pack_flag_backgrounds = 4;
globalvar room_pack_flag_tiles; room_pack_flag_tiles = 8;
globalvar room_pack_flag_views; room_pack_flag_views = 16;
globalvar room_pack_flag_sprites; room_pack_flag_sprites = 32;
globalvar room_pack_flag_all; room_pack_flag_all = 255;
